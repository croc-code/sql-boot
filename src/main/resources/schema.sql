...
create view hr.users_view_materialized as
select *
from hr.users;
...
alter table hr.persons
  add constraint person_to_jobs_fk foreign key (id_job) references hr.jobs (id);
alter table hr.persons
  add constraint person_to_users_fk foreign key (id_user) references hr.users (id);

create view hr.persons_view_materialized as
select *
from hr.persons;
...
drop
schema bookings if exists cascade;
